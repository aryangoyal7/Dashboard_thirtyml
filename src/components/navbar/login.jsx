...
const LoginModal = () => {
  ...
  */
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post('http://35.192.171.200:5005/api/Clubusers/loginClub', {
        clubname,
        mobileNumber,
        password,
      });
  ...
  const handleRegister = async () => {
    try {
      const response = await axios.post('http://35.192.171.200:5005/api/Clubusers/registerClub', {
        clubname,
        mobileNumber,
        password,
      });
